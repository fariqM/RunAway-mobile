...
export class Login extends Component {
    ...
    render() {
            return ( <
                ...
                behavior = 'padding' > { /*SIMPLY RUN*/ } <
                View style = {
                    { flex: 1, justifyContent: 'center', alignItems: 0 'center' }
                } >
                <
                Text style = { styles.titleText } > Runaway(Prototype 0.5) < /Text>         < /
                View >
                ...
                disabled = {
                    (this.state.emailValid && this.state.passwordValid ? false : true)
                } >
                <
                View style = {
                    {
    ...
    Text style = {
        { fontSize: 18, color: '#076fd9', paddingLeft: 10 }
    }
    onPress = { this.goToCreateAccount } > Sign Up! < /Text> < /
        View >
